<div class="generic-container">
    <div class="panel panel-default">
        ...
        <div class="panel-heading d-panel-heading"><span class="lead">Specific User </span></div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input type="text" ng-model="ctrl.user.name" id="uname"
                                       class="username form-control input-sm" placeholder="输入姓名" required
                                       ng-minlength="3"/>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input type="text" ng-model="ctrl.user.age" id="age" class="form-control input-sm"
                                       placeholder="输入年龄" required ng-pattern="ctrl.onlyIntegers"/>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input type="text" ng-model="ctrl.user.salary" id="salary" class="form-control input-sm"
                                       placeholder="输入工资." required ng-pattern="ctrl.onlyNumbers"/>
                            </div>
                        </div>
                    </div>
    ...
    <div class="panel panel-default">
        <!-- Default panel contents -->
        <div class="panel-heading d-panel-heading"><span class="lead">List of Users </span></div>
        <div class="panel-body">
